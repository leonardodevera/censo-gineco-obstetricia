...
function hideOriginalTasks(){const task=document.getElementById('taskText');if(!task)return;const section=task.closest('.full')||task.parentElement;if(section)section.classList.add('originalTasksHidden')}
function install(){
 ...
 .originalTasksHidden{display:none!important}.quickPatientNav{padding:8px 14px 0;background:#fff;position:sticky;top:0;z-index:2}.quickPatientNav button{padding:8px 12px;font-size:12px;font-weight:800;border-radius:999px;border:1px solid #cbd5e1;background:#f8fafc;color:#334155}.quickPatientNav button.hasPending{background:#fff7d6;border-color:#e5b700;color:#7a5200}
